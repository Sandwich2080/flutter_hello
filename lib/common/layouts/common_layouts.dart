...
import 'package:flutter_hello/common/layouts/shadow_example.dart';
...
class CommonLayoutsState extends State<CommonLayouts> {
  ...
  void _gotoShadowExample() {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => ShadowExample()));
  }
